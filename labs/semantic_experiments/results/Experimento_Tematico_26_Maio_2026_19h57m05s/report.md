...
*   **Grid de Resolução**: 27x27 (729 células/neurônios, taxa de retenção de $\approx 95\%$ em relação ao vetor 768D original).
*   **Densidade de Projeção**: 15.0% de ativação ativa ($K = 109$ células disparando por frase).
...
*   **Significado Cognitivo**: A probabilidade de sobreposição por classificação puramente aleatória em um grid com 15.0% de densidade é de exatamente **15.00%**.
...
## 5. Conclusão Geral
O alinhamento do grid **27x27** com o modelo **multilíngue de 768 dimensões** provou-se ideal. Conseguimos:
